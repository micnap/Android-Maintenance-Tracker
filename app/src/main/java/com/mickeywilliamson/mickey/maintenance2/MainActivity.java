...
public class MainActivity extends ListActivity {
    ...
    private List<MaintenanceTask> tasks = null;
    Toolbar toolbar;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        toolbar = (Toolbar) findViewById(R.id.toolbar_activity_main_actionbar);
    ...
    public void onResume() {
        super.onResume();
        DatabaseHandler db = new DatabaseHandler(this);
        List<MaintenanceTask> items = db.getAllMaintenanceTasks();
        TaskAdapter<MaintenanceTask> taskAdapter = new TaskAdapter<MaintenanceTask>(this, R.layout.task_row, items);
